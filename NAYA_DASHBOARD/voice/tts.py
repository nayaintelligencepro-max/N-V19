...
class Tts:
    ...
    def get_stats(self) -> Dict:
        with self._lock:
            return {
                "class": "Tts", "active": self._active, "healthy": self.is_healthy(),
