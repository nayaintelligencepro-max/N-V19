...
class StreamAbsorber:
    ...
    def __init__(self):
        ...
        log.debug(f"[StreamAbsorber] Initialized")
    ...
    def start(self, *args, **kwargs) -> Any:
        ...
        with self._lock:
            ...
            try:
                ...
                self._error_count += 1
                log.error(f"[StreamAbsorber] start error: {e}")
                return None
    ...
    def _execute_start(self, *args, **kwargs) -> Any:
        ...
        log.debug(f"[StreamAbsorber] Executing start")
    ...
    def configure(self, config: Dict[str, Any]):
        ...
        with self._lock:
            ...
            log.info(f"[StreamAbsorber] Config updated: {list(config.keys())}")
    ...
    def __repr__(self):
        return f"<StreamAbsorber ops={self._operation_count} errors={self._error_count}>"
