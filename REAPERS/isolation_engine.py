...
class IsolationEngine:
    ...
    def quarantine(self, module_name: str) -> None:
        ...
        with self._lock:
            ...
            self._quarantine_log[module_name] = datetime.now(timezone.utc)

            log.info(f"[REAPERS] Module quarantined: {module_name}")
    ...
    def reintegrate(self, module_name: str) -> None:
        ...
        with self._lock:
            ...
            log.info(f"[REAPERS] Module reintegrated: {module_name}")
    ...
    def reset_all(self) -> None:
        ...
        with self._lock:
            ...
            log.info("[REAPERS] All quarantine states cleared")
