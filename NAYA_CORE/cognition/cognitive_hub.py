...
log = logging.getLogger("NAYA.COGNITION")
...
class CognitiveHubNAYA:
    ...
    def analyze_opportunity_for_market(
        ...
        log.info(f"[COGNITION] Analyzing opportunity {opportunity.get('id')} with INTELLIGENCE engine...")
        ...
        log.info(f"[COGNITION] Perceiving market {market_profile.market_name} with PERCEPTION engine...")
        ...
        log.info(f"[COGNITION] Generating ADAPTATION plan for {market_profile.market_name}...")
        ...
        log.info(f"[COGNITION] HUMANIZING message for {market_profile.market_name}...")
        ...
        log.info(f"[COGNITION] Composing native message in {market_profile.primary_language_code}...")
...
# Global singleton
_cognitive_hub = None
_cognitive_hub_lock = __import__('threading').Lock()
